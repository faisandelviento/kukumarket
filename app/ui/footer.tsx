  ...
  return (
    ...
    <FooterContainer>
      ...
      <FooterSection>
        <h3>CATEGORIAS</h3>
        <ul>
          <li><FooterLink href="/prueba">Categoría 1</FooterLink></li>
          <li><FooterLink href="/">Categoría 2</FooterLink ></li>
          <li><FooterLink href="/">Categoría 3</FooterLink ></li>
          <li><FooterLink href="/">Categoría 4</FooterLink ></li>
        </ul>
      </FooterSection>
      <FooterSection>
        <h3>LINKS</h3>
    ...
    {/* Aquí se agrega la línea vertical */}
      ...
      <FooterSection>
        ...
        <SocialIcons>
          <FooterLink id="whatsappIcon" href="https://wa.me/34632360550" target="_blank">
          ...
          <FooterLink id="facebookIcon" href="https://www.facebook.com/kuku.repairs" target="_blank">
            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0 0 30 30">
